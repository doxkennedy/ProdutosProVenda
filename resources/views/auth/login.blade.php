                        ...
                        <form method="POST" class="my-login-validation" novalidate="" action="{{ route('login') }}">
                            ...
                            <div class="form-group">
                                <div class="custom-checkbox custom-control">
                                    ...
                                    <label for="remember" class="custom-control-label">   {{ __('Lembre-Me') }}</label>
                                </div>
                            </div>
                            ...
                            <div class="mt-4 text-center">
                                Não possui uma conta?  <a class="nav-link" href="{{ route('register') }}">{{ __('Registrar') }}</a>
                            </div>
                        </form>
                    </div>
                </div>
                <div class="footer">
                    Copyright &copy; 2017 &mdash; DoxCorporation
                </div>
            </div>
        </div>
    </div>
